...
class DashButton extends StatefulWidget {
  ...
  /// button padding with [DashSpacing.xxs] value default
  ...
  ///
  /// The default value is [DashBorderRadius.lg].
